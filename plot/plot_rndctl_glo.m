...
lo = baseline_correct([ squeeze(glo_spks.conv(i,2:end-1,find(glo_info.lo_rndctl)-3)); ...
...
go = baseline_correct([ squeeze(glo_spks.conv(i,2:end-1,find(glo_info.go_rndctl)-3)); ...
