function plot_compare_local_1(i, glo_info, glo_spks, varargin); hold on;
...
go2 = baseline_correct(squeeze(glo_spks.conv(i,:,find(glo_info.rndctl & glo_info.ori == glo_info.lo))), bl_epoch);
...
title('Local Oddball Response - 1')
legend([Global, Ident],{'Local','Ori in RND'},'location','northwest')
