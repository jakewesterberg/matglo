...
glo = baseline_correct([ squeeze(glo_spks.conv(i,2:end-1,find(glo_info.go_gloexp)-3)); ...
...
rnd = baseline_correct([ squeeze(glo_spks.conv(i,2:end-1,find(glo_info.go_rndctl)-3)); ...
...
seq = baseline_correct([ squeeze(glo_spks.conv(i,2:end-1,find(glo_info.go_seqctl)-3)); ...
