function plot_gloexp(i,glo_info, glo_spks, varargin); hold on;
...
lo = baseline_correct([ squeeze(glo_spks.conv(i,2:end-1,find(glo_info.lo_gloexp)-3)); ...
                        squeeze(glo_spks.conv(i,onoff_epoch,find(glo_info.lo_gloexp)-2)); ...
                        squeeze(glo_spks.conv(i,onoff_epoch,find(glo_info.lo_gloexp)-1)); ...
                        squeeze(glo_spks.conv(i,onoff_epoch,find(glo_info.lo_gloexp)))], ...
                        bl_epoch);
...
go = baseline_correct([ squeeze(glo_spks.conv(i,2:end-1,find(glo_info.go_gloexp)-3)); ...
...
legend([Local,Global],{'Local','Global'},'location','northwest', 'box', 'on')
