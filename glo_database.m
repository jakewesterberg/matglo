        ...
        for k = 1 : numel(COMPARISONS_2_SAMPLE{j}{2})
            ...
            for m = 1 : numel(CONDITIONS)
                if strcmp(CONDITIONS{m}{1}, COMPARISONS_2_SAMPLE{j}{4})
                    ...
                    temp_condition_1 = m;
                elseif strcmp(DIFFERENCE_FUNCTIONS{m}{1}, COMPARISONS_2_SAMPLE{j}{4})
                    temp_condition_inds_1 = DIFFERENCE_FUNCTIONS{m}{2};
                    temp_condition_1 = m;
                end
                if strcmp(CONDITIONS{m}{1}, COMPARISONS_2_SAMPLE{j}{5})
                    temp_condition_inds_2 = CONDITIONS{m}{2};
                    temp_condition_2 = m;
                elseif strcmp(DIFFERENCE_FUNCTIONS{m}{1}, COMPARISONS_2_SAMPLE{j}{5})
                    temp_condition_inds_2 = DIFFERENCE_FUNCTIONS{m}{2};
                    temp_condition_2 = m;
                end
            end
        ...
        for k = 1 : numel(COMPARISONS_GROUPWISE{j}{2})
            ...
            for m = 4 : numel(COMPARISONS_GROUPWISE{j})
                for n = 1 : numel(CONDITIONS)
                    ...
                    elseif strcmp(DIFFERENCE_FUNCTIONS{n}{1}, COMPARISONS_GROUPWISE{j}{m})
                        temp_condition_inds{m-3} = DIFFERENCE_FUNCTIONS{n}{2};
                    end
                end
            end
